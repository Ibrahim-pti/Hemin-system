...
<body class="h-full bg-slate-50 text-slate-800 antialiased font-sans"
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div x-show="mobileOpen"
             ...
             class="no-print fixed inset-0 z-40 bg-slate-900/50 backdrop-blur-xs md:hidden"></div>
        ...
        <div class="flex flex-1 flex-col overflow-hidden min-w-0 bg-slate-50">
            ...
            <header class="no-print flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 md:px-6">
                ...
                <div class="flex items-center gap-3 overflow-hidden">
                    <button type="button"
                            ...
                            class="flex size-9 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-slate-50 text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
                            title="مێنیو">
